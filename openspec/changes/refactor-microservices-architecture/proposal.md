...
- Quantify operational overhead shifts (K3s, NGINX Ingress, Redis, PostgreSQL, Helm, CI/CD, monitoring, multi-service ops across FastAPI/Flask/Django).
...
- Operational tooling (NGINX Ingress, Redis, PostgreSQL)
